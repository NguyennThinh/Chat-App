...
public class AddParticipantAdapter extends RecyclerView.Adapter<AddParticipantAdapter.MemberViewHolder> {
    ...
    public AddParticipantAdapter(List<User> arrUser, iAddMemberGroup addMemberGroup, Work work) {
    ...
    public void onBindViewHolder(@NonNull MemberViewHolder holder, int position) {
        ...
        ref.child(work.getLeader()).child(work.getId()).child("participant").child(user.getId())
