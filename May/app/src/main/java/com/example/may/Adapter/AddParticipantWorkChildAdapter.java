...
public class AddParticipantWorkChildAdapter  extends RecyclerView.Adapter<AddParticipantWorkChildAdapter.MemberViewHolder>{
    private List<User> arrUser;
    iAddMemberGroup addMemberGroup;
    private Work work;
    private List<User> mUsers = new ArrayList<>();
    private String idGroup;
    public AddParticipantWorkChildAdapter(List<User> arrUser, iAddMemberGroup addMemberGroup, Work work, String idGroup) {
