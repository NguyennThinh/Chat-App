...
public class LayoutMessagePickGallery extends RecyclerView.Adapter<LayoutMessagePickGallery.PickViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PickViewHolder holder, int position) {
        ...
        if (messageType.equals("image")){
            ...
            String filenameArray[] = getFileName(uri, holder.itemView.getContext()).split("\\.");
            String extension = filenameArray[filenameArray.length-1];

            if (extension.equals("doc")||extension.equals("docx")){
                holder.imgPDF.setImageResource(R.drawable.word);
            }else if (extension.equals("xls")||extension.equals("xlsx")){
                holder.imgPDF.setImageResource(R.drawable.excel);
            }else {
                holder.imgPDF.setImageResource(R.drawable.ic_pdf_message);
            }
        }
